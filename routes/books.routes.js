...
const booksController = require('../controllers/books.controller');  // importa controlador
...
module.exports = router;  //Exporta ek objeto de rutas que es el conjunto de rutas declaradas